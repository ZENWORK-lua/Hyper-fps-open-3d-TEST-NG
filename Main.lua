...
-- [[ SİNEMATİK AKIŞ: GARANTİLİ PLATOBOOST KONTROLÜ ]] --
task.spawn(function()
    waitUnpaused(0.5)
    ...
    overlay.Activated:Connect(function(inputObject)
        ...
        if not api then
            ...
            -- Maskot silinir, _G.HyperMainStart ASLA TRUE OLMAZ!
            isFollowing = false
        ...
        -- KEY ARAYÜZÜ/DOĞRULAMA TETİKLENİR
        ...
        -- KEY BAŞARILIYSA ARAYÜZ SİNYALİ VERİLİR
        if isVerified then
